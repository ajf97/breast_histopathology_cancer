...
def visualise_breast_tissue(
    patient_id,
    df=df,
    model=None,
    crop_dimension=[50, 50],
):
    ...
    for x, y, target, path in zip(
        ...
        if model is not None:
            ...
            if prediction != 0:
                mask[y : y + crop_dimension[1], x : x + crop_dimension[0]] = [
                    255,
                    127,
                    0,
                ]
            ...
            mask[
                y : y + crop_dimension[1],
                x : x + crop_dimension[0],
            ] = [0, 255, 0]
